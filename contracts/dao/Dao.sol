...
contract DPTDao is IERC20, Context {
    ...
    constructor(
        ...
        _name = __name;
        _symbol = __symbol;
        _decimals = IERC20(_DPT).decimals();
    ...
    function deposit(uint256 _amount) public onlyHuman {
        ...
        uint256 _before = IERC20(bpt).balanceOf(address(this));
        IERC20(bpt).safeTransferFrom(msg.sender, address(this), _amount);
        uint256 _after = IERC20(bpt).balanceOf(address(this));
    ...
    function withdraw(uint256 _shares) public onlyHuman {
        ...
        IERC20(bpt).safeTransfer(msg.sender, r);
    }
